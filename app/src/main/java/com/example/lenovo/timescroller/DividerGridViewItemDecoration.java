...
/**
 * Created by yuanliang on 2016/7/22.
 */
public class DividerGridViewItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public void drawHorizontal(Canvas c, RecyclerView parent) {
        ...
        int offset = childCount % spanCount;
        if (offset == 0) {
            offset = spanCount;
        }
    ...
    public void drawVertical(Canvas c, RecyclerView parent) {
        ...
        int spanCout = getSpanCount(parent);
        int offset = childCount % spanCout;
        for (int i = 0; i < childCount; i++) {

            if ((i + 1) % spanCout == 0)
                continue;
            if (offset != 0 && i == childCount - 1) {
                continue;
            }
